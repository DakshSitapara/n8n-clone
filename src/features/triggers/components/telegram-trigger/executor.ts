...
type TelegramaTriggerData = Record<string, unknown>

export const telegramTriggerExecutor: NodeExecutor<TelegramaTriggerData> = async ({ nodeId, context, step, publish }) => {
    await publish(
