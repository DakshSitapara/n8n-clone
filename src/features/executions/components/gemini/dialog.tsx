...
export type GeminiFromValues = z.infer<typeof fromSchema>

interface Props {
    open: boolean
    onOpenChange: (open: boolean) => void
    onSubmit: (values: z.infer<typeof fromSchema>) => void
    defaultValue?: Partial<GeminiFromValues>
}

export const GeminiDialog = ({ open, onOpenChange, onSubmit, defaultValue = {} }: Props) => {
