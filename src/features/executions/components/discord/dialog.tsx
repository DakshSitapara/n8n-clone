...
const fromSchema = z.object({
    ...
    content : z.string().min(1, { message: "Message content is required" }).max(2000, { message: "Discord message must be less than 2000 characters" }),
    webhookUrl : z.string().min(1, { message: "Webhook URL is required" }), 
});

export type DiscordFromValues = z.infer<typeof fromSchema>;

interface Props {
    open: boolean;
    onOpenChange: (open: boolean) => void;
    onSubmit: (values: z.infer<typeof fromSchema>) => void;
    defultValue?: Partial<DiscordFromValues>;
}

export const DiscordDialog = ({ open, onOpenChange, onSubmit, defultValue = {}, }: Props) => {
