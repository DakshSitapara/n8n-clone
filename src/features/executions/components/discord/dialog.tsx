...
const fromSchema = z.object({
    ...
    content: z
        ...
        .max(2000, { message: 'Discord message must be less than 2000 characters' }),
...
interface Props {
    ...
    defaultValue?: Partial<DiscordFromValues>
}

export const DiscordDialog = ({ open, onOpenChange, onSubmit, defaultValue = {} }: Props) => {
