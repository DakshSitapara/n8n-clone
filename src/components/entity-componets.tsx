...
export const EntityHeader = ({
    ...
    return (
        <div className="flex flex-row item justify-between gap-x-4">
...
export function EmptyList<T>({items, renderItem, getKey, emptyView, className} : EmptyListProps<T>)  {
