...
import UserProfile from '@/features/auth/user/components/UserProfile'
...
export const AppSidebar = () => {
    ...
    const ThemeIcon =
        !mounted || theme === 'system' ? Monitor : resolvedTheme === 'dark' ? Moon : Sun
                        ...
                        <SidebarMenuButton asChild className="h-10 gap-x-4 px-4">
                            <Link href="/" prefetch>
                                <Image
                                    ...
                                    height={30}
                                />
                                <span className="text-sm font-semibold">N8N Clone</span>
                            </Link>
                        </SidebarMenuButton>
                    </SidebarMenuItem>
                </SidebarMenu>
